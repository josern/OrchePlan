...
CREATE TABLE "TaskStatus" (
    "id" TEXT NOT NULL,
    "label" TEXT NOT NULL,
    "showStrikeThrough" BOOLEAN NOT NULL DEFAULT false,
    "color" TEXT,
...
-- AddForeignKey
ALTER TABLE "TaskComment" ADD CONSTRAINT "TaskComment_statusId_fkey" FOREIGN KEY ("statusId") REFERENCES "TaskStatus"("id") ON DELETE SET NULL ON UPDATE CASCADE;
